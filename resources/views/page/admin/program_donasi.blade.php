                ...
                <div class="container">
                    <div class="row">
                      <div class="col-sm text-center">
                       <a href="add_program_donasi.php"> <button type="button" class="btn btn-primary btn-sm">Add New Program Donasi</button></a>
                      </div>
                      <div class="col-sm">
                        ...
                        <div class="card mb-4 shadow-sm">
                          ...
                          <div class="card-body">
                            ...
                            <div class="d-flex justify-content-between align-items-center">
                              <div class="btn-group">
                               <a href="detail_program_donasi.php"><button type="button" class="btn btn-sm btn-outline-secondary">View</button></a>
